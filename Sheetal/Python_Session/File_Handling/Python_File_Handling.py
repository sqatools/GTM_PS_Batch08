...
#
#
# def read_specific_number_lines(lines_list, start, stop):
#     for i in range(start - 1, stop):
#         print(lines_list[i], end="")
#
#
# lines_list = read_list_of_lines("read_data.txt")
# read_specific_number_lines(lines_list, 5, 10)

print("_"*50)
def write_list_of_lines(filepath,lines_list):
    with open(filepath, "w") as file:
        file.writelines(lines_list)

lines_list = ("1. First line\n", "2. Second line\n", "3. Third line\n")
# lines_list = ["1. First line\n", "2. Second line\n", "3. Third line\n"]
write_list_of_lines("write_data.txt", lines_list)
