...
# emails, phones = read_email_phone("read_data_new.txt")
# print("emails :", emails)
...
replace_word_from_file("read_data_new.txt", "Python", "JAVA")


#Q3 : Read content from file1 and file2 and add content to the file3.

def read_content_file(filepath, file1, file2):
    ...
    # for _ in data1:
    #     data2.append(data1)
    update_content = data2+data1
    #update_content_str= str(update_content)
    with open(filepath, "w") as file:
        file.write(update_content)

read_content_file("read_data_file.txt", "file1.txt", "file2.txt")