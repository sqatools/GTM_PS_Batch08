...
# Given a list of non negative number and target integer K,
# check if the array has a continuous subarray of size at leats 2 that sum upto k
list1 = [1, 8, 3, 2, 4, 6, 7, 9, 5]
k = 7
# o/p=true

for i in range(len(list1)):
    for j in range(i+1, len(list1)):
        if sum([list1[i], list1[j]]) == k:
