...
# result1 : (25, 49, 81, 4, 25, 49)

tup_c = (11, 55, 88, 22, 66, 99)
result2 = tuple(['even', x] if x%2 == 0 else ['odd', x] for x in tup_c)
print(result2)
# (['odd', 11], ['odd', 55], ['even', 88], ['even', 22], ['even', 66], ['odd', 99])

"""
# 1) write a tuple program to get max from tuple without using max function
t1 = (55, 77, 203, 5, 1, 7)
output = 203

# 2) write a python program to get list of combination of two values whose sum is 20
t2 =(3, 6, 9, 10, 11, 12, 8, 14, 6)
(9, 11)
(12, 8)
(14, 6)

# 3) write a python program remove value which is repeated more than  two times and store in list
t3 = (1, 3, 1, 4, 1, 5, 3, 6, 3, 7, 3, 4, 4)
output = [5, 6 ,7]
"""
